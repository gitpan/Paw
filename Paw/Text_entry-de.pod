...
Die Callback Funktion wird bei jedem Tastendruck angesprungen, dabei wird der
Wert der gedrueckten Taste uebergeben und muss auch wieder zurueck gegeben werden,
wenn er in das Textentry soll. So laesst sich eine Art Filter programmieren, der z.B.
nur Ziffern zulaesst.
